...
import { X, BookOpen, Send, Loader } from 'lucide-react';
...
export function CourseRequestModal({ onClose, onSuccess }: CourseRequestModalProps) {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Erro ao solicitar disciplina:', error);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Por que esta disciplina é necessária?"
              rows={3}
