    ...
    <div
        ...
        >
          <button
            ...
            className={`absolute top-3 sm:top-4 right-3 sm:right-4 p-1.5 sm:p-2 rounded-full transition-all z-10 ${
              isFavorite
          ...
          <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <div className="flex-1 min-w-0 pr-6 sm:pr-8">
              <h3 className="font-bold text-gray-900 text-sm sm:text-base leading-snug group-hover:text-blue-600 transition-colors" style={{ display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                {course.name}
              </h3>
            </div>
          </div>
          ...
          <div className="mt-auto space-y-2 sm:space-y-3">
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              ...
              {course.period && (
                <span className="inline-flex items-center gap-1 px-1.5 sm:px-2 py-1 bg-blue-50 text-blue-600 text-[9px] sm:text-[10px] font-bold rounded-md uppercase tracking-wider">
                  <Calendar className="w-3 h-3" />
                  {course.period}º Período
                </span>
              )}
    
              <span className={`inline-flex items-center gap-1 px-1.5 sm:px-2 py-1 text-[9px] sm:text-[10px] font-bold rounded-md uppercase tracking-wider ${
                isMandatory
