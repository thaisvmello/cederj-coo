                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {deletingId === comment.id ? <Loader className="w-4 h-4 animate-spin" /> : <<dyad-write path="src/components/AdminCommentsManager.tsx" description="Corrigindo erro de sintaxe e completando o arquivo de moderação de comentários">
import { useState, useEffect } from 'react';
import { supabase } from '../lib/supabase';
import { Trash2, MessageSquare, Loader, RefreshCw, Folder, BookOpen, ExternalLink } from 'lucide-react';
import { useAdmin } from '../hooks/useAdmin';
