        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
          <Link to="/" onClick={onGoHome} className="flex items-center gap-2 sm:gap-4 hover:opacity-80 transition-opacity">
            ...
            <div className="border-l border-white/20 pl-2 sm:pl-4 flex items-center">
              <h1 className="text-[15px] sm:text-xl md:text-3xl font-extrabold leading-tight tracking-tight">
                Acervo Acadêmico
              </h1>
            </div>
          </Link>
          ...
          <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-4 text-xs sm:text-sm font-medium">
            ...
            <div className="relative shrink-0" ref={toolsRef}>
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg hover:bg-white/10 hover:text-white transition-colors shrink-0 ${
              ...
              {toolsOpen && (
                <div className="absolute left-0 sm:left-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 text-gray-800 animate-in fade-in slide-in-from-top-2 duration-150 z-50 whitespace-normal">
                  <button
                    onClick={() => {
                      onNavigateToCalculator?.();
                      setToolsOpen(false);
            ...
            <Link
              to="/tutorial"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg hover:bg-white/10 text-amber-300 hover:text-amber-200 transition-colors shrink-0"
            >
            ...
            <Link
              to="/feedback"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg hover:bg-white/10 text-rose-300 hover:text-rose-200 transition-colors shrink-0"
            >
