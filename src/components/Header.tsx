  ...
  return (
    <header className="w-full z-40 overflow-x-hidden">
      ...
      <div className="bg-[#00394a] text-white px-4 py-3 sm:py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <Link
            to="/"
            onClick={onGoHome}
            className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity flex-shrink-0 min-w-0"
          >
            <img
      ...
      {!isAdminPage && !isProfilePage && (
        <div className="bg-[#004157] text-gray-300 border-b border-[#002f3e] px-4 relative z-30 overflow-x-hidden">
          ...
          {/* Mobile Menu Content - Bottom Sheet Style */}
          {mobileMenuOpen && (
            <div className="sm:hidden animate-in fade-in slide-in-from-top-4 duration-200">
              <div className="flex flex-col bg-[#004157] border-t border-white/10">
                <button
                  onClick={() => {
                    onNavigateToCalculator?.()
                    setMobileMenuOpen(false)
                  }}
                  className="w-full text-left px-4 py-3 text-white font-semibold text-sm hover:bg-white/10 transition flex items-center gap-3"
                >
                  <Wrench className="w-4 h-4 text-blue-400" />
                  Ferramentas
                </button>
                ...
                <Link
                  to="/tutorial"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full text-left px-4 py-3 text-amber-300 font-semibold text-sm hover:bg-white/10 transition flex items-center gap-3"
                >
                  <HelpCircle className="w-4 h-4 text-amber-400" />
                  Tutorial: como usar o acervo
                </Link>
              </div>
            </div>
          )}
