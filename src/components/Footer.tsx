    ...
    <footer className="bg-[#103d51] text-gray-300 py-8 mt-12 border-t border-[#1a4b5f]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        <div className="space-y-2">
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-gray-400">
        ...
        <div className="space-y-1">
          <p className="text-[10px] sm:text-[11px] text-gray-400 max-w-2xl mx-auto leading-relaxed font-medium">
